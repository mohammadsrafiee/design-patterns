package ir.patterns.bihavioral.visitor;
...
import ir.patterns.bihavioral.visitor.impl.Directory;
import ir.patterns.bihavioral.visitor.impl.HumanReadableVisiror;
import ir.patterns.bihavioral.visitor.impl.IFile;
import ir.patterns.bihavioral.visitor.impl.IVisitor;
import ir.patterns.bihavioral.visitor.impl.ImageFile;
import ir.patterns.bihavioral.visitor.impl.TextFile;

public class VisitorExample {

	private List<IVisitor> visitors = new ArrayList<IVisitor>(Arrays.asList(new HumanReadableVisiror()));
	private IFile root;
